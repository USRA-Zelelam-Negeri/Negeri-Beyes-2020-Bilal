...
library(faraway)
mu.nr <- list(logit(c(0.5,0.6)),logit(c(0.5,0.6)),logit(c(0.5,0.6)),logit(c(0.5,0.6)),logit(c(0.5,0.6)),logit(c(0.5,0.6)),logit(c(0.5,0.6)))
mu.or <- list(logit(c(0.9,0.95)),logit(c(0.9,0.6)),logit(c(0.5,0.95)),logit(c(0.9,0.95)),logit(c(0.9,0.6)),logit(c(0.5,0.95)),logit(c(0.5,0.6)))
...
Sigma.or <- list(matrix(c(1.5,-0.2,-0.2,1.6),2,2),
                 ...
                 matrix(c(0.2,-0.2,-0.2,0.25),2,2),
                 matrix(c(0.2,-0.2,-0.2,0.6),2,2),
                 matrix(c(0.5,-0.2,-0.2,0.25),2,2),
                 matrix(c(0.5,-0.2,-0.2,0.6),2,2))
n <- c(100,200)
k <- c(10,20,30,40)
...
seed <- c(60, 19112, 19103, 63, 54, 18256, 66, 67, 68, 69, 70, 71, 114, 67, 52, 53, 54, 18256, 66, 67, 68, 69, 70, 71, 72, 73, 74, 75)
...
Se.s6 = Sp.s7 = Se.l6 = Sp.l7 <- list(); mat.len.out <- matrix(0, nrow=28, ncol=4)
for(i in 1:28){
