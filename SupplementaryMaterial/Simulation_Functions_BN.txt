...
Create.Figure <- function(mat.scen, Outl, Sigsize, fit.bnn, fit.bbn, fit.bnlm){
  ...
  filenames <- c("OutlSeSp_large.pdf", "OutlSe_large.pdf", "OutlSp_large.pdf", "OutlSeSp_small.pdf", "OutlSe_small.pdf", "OutlSp_small.pdf", "NoOutl.pdf")
  ...
  # Plot results
  pdf(file = filenames[ceiling(i/4)], width = 12, height = 6)
